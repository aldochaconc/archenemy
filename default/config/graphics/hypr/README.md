...
- `get_terminal_cwd` - Get working directory of focused terminal
- `launch_terminal_cwd [TERMINAL]` - Open terminal in current directory
- `launch_webapp URL [BROWSER]` - Open URL as PWA
- `summon_app APP_CLASS` - Move app to current workspace
...
- `toggle_screenrecord` - Start/stop recording
