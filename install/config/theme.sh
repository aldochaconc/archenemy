...
ln -snf ~/.config/omarchy/themes/archenemy ~/.config/omarchy/current/theme
ln -snf ~/.config/omarchy/current/theme/backgrounds/01.png ~/.config/omarchy/current/background
